...
async function main() {
  ...
  deploysData.AlgebraEternalFarming = AlgebraEternalFarming.address
  ...
  deploysData.FarmingCenter = FarmingCenter.address
  ...
  await AlgebraEternalFarming.setFarmingCenterAddress(FarmingCenter.address, { gasLimit: 1000000 })
  ...
  await factory.setFarmingAddress(FarmingCenter.address, { gasLimit: 1000000 })
  ...
  await posManager.setFarmingCenter(FarmingCenter.address, { gasLimit: 1000000 })
